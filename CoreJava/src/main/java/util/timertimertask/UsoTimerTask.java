 ...
 * java.util.TaskQueue para a�adir tareas cada un intervela regular de tiempo y
 ...
 * tarda en ejecutarlo 20 segundos, el objeto Timer ser� a�adido a las tareas en
 * la cola y tan pronto como el hilo termine, este notificar� a la cola y otro
 * hilo comenzar� la ejecucion.
 * 
 * 
 * La clase java Timer usa los metodos de sincronizacion wait y notify para
 * programar las tareas. Si el timer se ejecuta como un daemond thread,
 * terminar� tan pronto como todos los subprocesos del usuario terminen de
 * ejecutarse
 * 
 * 
...
public class UsoTimerTask {
	...
	public static void main(String args[]) {
		...
		// asi, se ejecutar� repetidamente cada initialDelay + X * (10*1000),
		...
		// detiene el resto de tareas programadas, pero espera que finalice la
		// actual
		timer.cancel();
		System.out.println("TimerTask cancelled at: " + new Date());

		// este sleep es para dejar terminar la tarea pendiente, en caso de no
		// existir
		// el Timer lanzado como daemon thread se detendr� y con el todas las
		// tareas
		try {
