package com.apr.reflection.staticelements;
...
public class ReflectionStatic {
	...
	public static void main(String[] args) throws NoSuchMethodException, SecurityException, IllegalAccessException,
		...
		try {
			Class<?> forname = Class.forName("com.apr.reflection.staticelements.ReflectionStatic.StaticExample");
		...
		// class
		Class<?>[] classes = ReflectionStatic.class.getDeclaredClasses();
